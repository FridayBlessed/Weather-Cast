const apiKey = '51b4a7b8fc33a5a0b779ba74ce4be0ea';
...
async function checkWeather(city) {
    ...
    if (data.cod === 200) {
        ...
        if (data.weather[0].main === 'Clouds') {
            weatherIcon.src = 'assets/img/cloudy.svg';
        } else if (data.weather[0].main === 'Clear') {
            weatherIcon.src = 'assets/img/clear.svg';
        } else if (data.weather[0].main === 'Rain') {
            weatherIcon.src = 'assets/img/rainy.svg';
        } else if (data.weather[0].main === 'Drizzle') {
            weatherIcon.src = 'assets/img/drizzle.svg';
        } else if (data.weather[0].main === 'Mist') {
            weatherIcon.src = 'assets/img/drizzle.svg';
        } else if (data.weather[0].main === 'Snow') {
            weatherIcon.src = 'assets/img/snowy.svg';
        }
    } else {
